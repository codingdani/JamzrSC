...
contract NFTMarketplace is ERC1155Holder, ReentrancyGuard, Ownable {
    ...
    function buyNFT(uint256 _listingId, uint256 _quantity) external payable nonReentrant {
        ...
        require(msg.value >= listing.price * _quantity, "Insufficient payment");
        ...
        Transaction memory newTransaction = Transaction(_listingId, msg.sender, listing.price, _quantity, block.timestamp);
        listingTransactions[_listingId].push(newTransaction);
